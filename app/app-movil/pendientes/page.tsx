      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-bold text-gray-900">Pendientes Hoy</h1>
          </div>
          <span className="text-sm text-gray-500">{allPending?.length || 0}</span>
        </div>
      </header>

      <div className="px-4 py-3">
        <div className="bg-orange-50 border border-orange-100 rounded-lg p-3 mb-4 flex items-center gap-2">
          <Clock className="w-5 h-5 text-orange-500" />
          <span className="text-sm text-orange-700">Tienes {allPending?.length || 0} tareas para hoy</span>
        </div>
